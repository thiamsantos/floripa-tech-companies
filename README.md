...
[Audaces](https://www.audaces.com/) |  `Angular`, `C#`, `C++`, `Java`, `Javascript`, `Python`, `SQL Server`, `PostgreSQL`, `Typescript` | João Paulo, Florianópolis | (https://www.adpweb.com.br/adpbr/cgiip.exe/WService=rhweb25pro/curricweb_vagas.r)
...
[Decora](https://cora.creativedrive.com/) | `Java`, `Angular` | Saco Grande, Florianópolis | (https://jobs-creativedrive.icims.com/jobs/search?hashed=-435738768&mobile=false&width=1440&height=500&bga=true&needsRedirect=false&jan1offset=-300&jun1offset=-240)
[Dígitro Tecnologia](http://www.digitro.com/pt/) | `Javascript`, `Ember`, `Erlang`, `MongoDB`, `Java` | Capoeiras, Florianópolis | (http://www.digitro.com/pt/index.php/a-digitro/talentos-e-carreiras/oportunidades)
...
[Intelbras](https://intelbras.com.br) | `Python`, `Go`, `Java`, `C`, `Javascript`, `Lua` | Area Industrial, São José | (https://trabalheconosco.intelbras.com.br/curriculoweb/conector?ACAO=CURRICULO&STATUS=TELALOGIN&SIS=RS&PERFIL=1&IDIOMA=0&BASE=NOVOCURRICULO)
